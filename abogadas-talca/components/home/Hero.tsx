...
export default function Hero() {
  ...
  const a = (props: ReturnType<typeof fadeUp>) => (reduced ? {} : props);

  return (
    <section className="relative min-h-screen overflow-hidden bg-[#1E1E2E]">

      {/* ── Foto: mobile (absolute derecha) ── */}
        ...
        <div className="flex flex-col justify-center pt-28 pb-12 pl-6 pr-4 lg:px-16 lg:pt-32 lg:pb-20">
          ...
          <motion.div className="flex flex-col gap-3 max-w-[240px]" {...a(fadeUp(0.65))}>
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-full py-3 px-5 text-sm font-medium text-white transition-colors"
            ...
            <a
              href="#areas"
              className="flex items-center justify-center rounded-full border border-white/30 py-3 px-5 text-sm text-white transition-colors hover:border-white/70 bg-transparent"
            >
